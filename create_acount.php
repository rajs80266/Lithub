<?php
	...
	if(isset($_POST['create']))
	{
		...
		else
		{
			...
			if($flag==1)
			{
				mysqli_query($conn,"INSERT INTO users(user,pwd,email) VALUES ('$uname','$password','$email')");
				mysqli_query($conn,"CREATE TABLE userp".$x." (id INT AUTO_INCREMENT PRIMARY KEY,pname VARCHAR(255),flag INT,public INT)");
...
<html>
	...
	<body>
		<center>
			<h1>Create an account of Best sharing site!</h1>
